...
* `TaskEleven.tex` - исходный код решения задачи №19;
* `TaskTwelve.tex` - исходный код решения задачи №20;
* `TaskThirteen.tex` - исходный код решения задачи №21;
* `TaskFourteen.tex` - исходный код решения задачи №22;
